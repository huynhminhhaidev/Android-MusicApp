...
//            mMusicPlayerService.pause();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.e("TAG", stopService(serviceIntent) + "");
    ...
    private void createChanelNotification() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            NotificationChannel channel = new NotificationChannel(MusicNotification.CHANEL_ID, "3PM", NotificationManager.IMPORTANCE_LOW);
    ...
    private void init() {
        getSupportActionBar().setTitle("Trình phát nhạc");
        ...
        if (songList.size() > 0) {
            ...
            tvName.setText(songList.get(0).getTenBH());
            Log.e("LINK", songList.get(0).getLinkBH());
//            new PlayMp3().execute(songList.get(0).getLinkBH());
    ...
    public void onTrackPrevious() {
        ...
        tvName.setText(songList.get(position).getTenBH());
        isPlaying = true;
    }
    ...
    public void onTrackPlay() {
        ...
        tvName.setText(songList.get(position).getTenBH());
        isPlaying = true;
        Log.e("TAG",songList.get(position).toString());
    }
